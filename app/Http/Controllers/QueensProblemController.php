...
class QueensProblemController extends Controller
{
    ...
    public function index()
    {
        ...
        $fen_solutions = $this->solve_queens_problem();
     ...
     * @return array
     */
    private function solve_queens_problem(): array
    {
     ...
     */
    private static function add_constraints(int $rank, int $file, $constraints = [], int $board_size = 7): array
    {
